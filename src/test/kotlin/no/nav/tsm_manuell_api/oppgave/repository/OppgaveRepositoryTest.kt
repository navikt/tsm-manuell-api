...
class OppgaveRepositoryTest {
    ...
    fun `opprettManuellOppgave should create entry in database using ManuellOppgave object`() {
        ...
        val manuellOppgave = createTestManuellOppgave("test-sykmelding-1", ManuellOppgaveStatus.APEN)
    ...
    fun `opprettManuellOppgave should serialize sykmelding as JSON`() {
        ...
        val manuellOppgave = createTestManuellOppgave(sykmeldingId, ManuellOppgaveStatus.FERDIGSTILT)
    ...
    private fun createTestXmlSykmelding(sykmeldingId: String): XmlSykmelding {
        ...
        return XmlSykmelding(
            ...
            behandler = Behandler(
                ...
                ids = listOf(
                    PersonId(id = "12345678901", type = PersonIdType.FNR)
                ),
                kontaktinfo = emptyList()
            ),
            sykmelder = Sykmelder(
